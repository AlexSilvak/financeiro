...
import PDFViewClient from "@/components/PDFViewClient"
...
export default function search() {
  ...
  const [_id,setId]=useState([])
   ...
   <Table>
      ...
      <TableHeader>
        <TableRow>
          <TableHead className="items-center">Descrição</TableHead>
      ...
      {  lancamentos.map((item:any)=>{
        ...
        let  valor_total_pagar=item.valor+item.juros+item.multa
          return (
            ...
            <TableRow >      
              <TableCell className="items-start">{item.descricao}</TableCell>
